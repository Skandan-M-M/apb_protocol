#include "isim/work/tb__apb__read__no__wait/tb__apb__read__no__wait.h"
#include "isim/work/glbl/glbl.h"
static const char * HSimCopyRightNotice = "Copyright 2004-2005, Xilinx Inc. All rights reserved.";


#include "work/tb__apb__read__no__wait/tb__apb__read__no__wait.h"
static HSim__s6* IF0(HSim__s6 *Arch,const char* label,int nGenerics, 
va_list vap)
{
    HSim__s6 *blk = new workMtb__apb__read__no__wait(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("tb_apb_read_no_wait", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        topvl = new workMtb__apb__read__no__wait("tb_apb_read_no_wait");
